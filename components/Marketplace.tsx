...
function FundPanel() {
  ...
  return (
    <div className="mo-wrap">
      <section className="mkt-fund">
        <div className="mo-features-head">
          <span>// Fund your own</span>
          <span>Board · {String(open.length).padStart(2, "0")}</span>
        </div>
        <div className="mo-axis" />
        <div className="mkt-fund-row">
          <div className="mkt-fund-copy">
            <h2 className="mkt-h2">Back a topic you want us to cover.</h2>
                ...
                {open.map((idea, i) => (
                  <li key={idea.id} className="mkt-board-row">
                    ...
                    <span className="board-amt">
                      {idea.total_cents > 0 ? formatMoney(idea.total_cents) : "—"}
                    </span>
                    <button
                      type="button"
                      className="mo-link"
